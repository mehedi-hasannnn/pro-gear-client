        ...
        children: [
            {
                path: '/',
                element: <Home/>,
                loader: ()=>fetch('https://pro-gear-server.vercel.app/equipment-home')
            },
            {
                path: '/addEquipment',
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://pro-gear-server.vercel.app/equipment/${params.id}`) 
            },
            {
                path: '/allList',
                element: <PrivateRoute><EquipmentList/></PrivateRoute>,
                loader: ()=>fetch('https://pro-gear-server.vercel.app/equipment')
            },
            {
                path: '/allSports',
